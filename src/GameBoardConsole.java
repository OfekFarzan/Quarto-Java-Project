...
public class GameBoardConsole {
    private GameLogic qb;
    private AiComputer compy;
    private GameBoard gui;

    public GameBoardConsole( GameLogic board, AiComputer comp ) {
        this.qb    = board;
        this.compy = comp;
        this.gui   = new GameBoard( qb );
    }
    ...
    public void go() {
        ...
        while (true) {
            ...
            //
                ...
                try {
                    user_pass = Piece.getIndexFromString( user_input.substring(5,user_input.length()) );
                ...
                if ( qb.pass( user_pass ) ) {
                    ...
                    System.out.println( "Computer passes piece " + cmove.passedPiece + ":" +
                            Piece.getStringFromIndex(cmove.passedPiece) + " to you. Your move." );
